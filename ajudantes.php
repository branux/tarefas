...
function preparar_corpo_email($tarefa, $anexos)
{
	...
	// Incluiro arquivo template_email.php:
...
function enviar_email($tarefa, $anexos = array())
{
	...
	$email->SMTPAuth = true;
	$email->Username = "digite aqui o email de origem";
	$email->Password = "senha do email de origem";
	$email->setFrom("email de origem", "Avisador de Tarefas");
